...
import { WebhookConfiguration, Webhooks } from './resources/webhooks';
import {
  Contact,
...
export interface ClientOptions {
   ...
   * Set the log level.
   *
   * Defaults to process.env['SENDBLUE_API_LOG'] or 'warn' if it isn't set.
   */
...
export class SendblueAPI {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? SendblueAPI.DEFAULT_TIMEOUT /* 1 minute */;
  ...
  protected async apiSecretAuth(opts: FinalRequestOptions): Promise<NullableHeaders | undefined> {
...
export declare namespace SendblueAPI {
  ...
  export { Webhooks as Webhooks, type WebhookConfiguration as WebhookConfiguration };
}
