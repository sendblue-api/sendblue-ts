...
const remoteStainlessHandler = async (
  ...
  SENDBLUE_API_API_KEY: requireValue(readEnv('SENDBLUE_API_API_KEY') ?? client.apiKey, 'set SENDBLUE_API_API_KEY environment variable or provide apiKey client option'),
  SENDBLUE_API_API_SECRET: requireValue(readEnv('SENDBLUE_API_API_SECRET') ?? client.apiSecret, 'set SENDBLUE_API_API_SECRET environment variable or provide apiSecret client option'),
  ...
  try {
    const resp = await new Promise<Response>((resolve, reject) => {
      ...
      const opts = {
          ...
          ...(client.apiSecret != null ? { apiSecret: client.apiSecret } : undefined),
          defaultHeaders: {
