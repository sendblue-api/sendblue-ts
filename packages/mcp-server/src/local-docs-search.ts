...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    response:
      "{ data?: { accountEmail?: string; content?: string; date_sent?: string; date_updated?: string; error_code?: number; error_detail?: string; error_message?: string; error_reason?: string; from_number?: string; group_display_name?: string; group_id?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; opted_out?: boolean; participants?: string[]; plan?: string; seat_id?: string; send_style?: string; sendblue_number?: string; sender_email?: string; service?: 'iMessage' | 'SMS' | 'RCS'; status?: string; to_number?: string; was_downgraded?: boolean; }[]; pagination?: { hasMore?: boolean; limit?: number; offset?: number; total?: number; }; status?: string; }",
    markdown:
  ...
  },
  {
    ...
    response:
      "{ account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }",
    markdown:
      "## send\n\n`client.messages.send(content: string, from_number: string, number: string, media_url?: string, seat_id?: string, send_style?: string, status_callback?: string): { account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: object; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }`\n\n**post** `/api/send-message`\n\nSend an iMessage, SMS, or MMS to a single recipient\n\n### Parameters\n\n- `content: string`\n  Message text content\n\n- `from_number: string`\n  **REQUIRED** - The phone number to send from. Must be one of your registered Sendblue phone numbers in E.164 format.\nWithout this parameter, the message will fail to send.\n\n\n- `number: string`\n  Recipient phone number in E.164 format\n\n- `media_url?: string`\n  URL of media file to send (images, videos, etc.)\n\n- `seat_id?: string`\n  Optional. Identifies the seat (user) sending the message so the message\nis attributed to a specific rep. Accepts either the seat UUID or the\nFirebase Auth subject. When provided, `sender_email` is auto-populated\non the message record and webhook payloads. Returns 400 if the seat is\nnot found.\n\n\n- `send_style?: string`\n  The iMessage expressive message style\n\n- `status_callback?: string`\n  Webhook URL for message status updates\n\n### Returns\n\n- `{ account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }`\n\n  - `account_email?: string`\n  - `content?: string`\n  - `date_created?: string`\n  - `date_updated?: string`\n  - `error_code?: number`\n  - `error_message?: string`\n  - `from_number?: string`\n  - `is_outbound?: boolean`\n  - `location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }`\n  - `media_url?: string`\n  - `message_handle?: string`\n  - `message_type?: 'message' | 'group' | 'location'`\n  - `number?: string`\n  - `seat_id?: string`\n  - `send_style?: string`\n  - `sender_email?: string`\n  - `status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'`\n\n### Example\n\n```typescript\nimport SendblueAPI from 'sendblue';\n\nconst client = new SendblueAPI();\n\nconst messageResponse = await client.messages.send({\n  content: 'Hello, World!',\n  from_number: '+19998887777',\n  number: '+19998887777',\n});\n\nconsole.log(messageResponse);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }",
    markdown:
      "## get_status\n\n`client.messages.getStatus(handle: string): { account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: object; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }`\n\n**get** `/api/status`\n\nRetrieve the current status of a message using its message handle. Useful for resolving pending message statuses and avoiding duplicate messages.\n\n\n### Parameters\n\n- `handle: string`\n  The message handle of the message you want to check status for\n\n### Returns\n\n- `{ account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }`\n\n  - `account_email?: string`\n  - `content?: string`\n  - `date_created?: string`\n  - `date_updated?: string`\n  - `error_code?: number`\n  - `error_message?: string`\n  - `from_number?: string`\n  - `is_outbound?: boolean`\n  - `location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }`\n  - `media_url?: string`\n  - `message_handle?: string`\n  - `message_type?: 'message' | 'group' | 'location'`\n  - `number?: string`\n  - `seat_id?: string`\n  - `send_style?: string`\n  - `sender_email?: string`\n  - `status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'`\n\n### Example\n\n```typescript\nimport SendblueAPI from 'sendblue';\n\nconst client = new SendblueAPI();\n\nconst messageResponse = await client.messages.getStatus({ handle: 'msg_abc123def456' });\n\nconsole.log(messageResponse);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }",
    markdown:
      "## send_message\n\n`client.groups.sendMessage(content: string, from_number: string, group_id?: string, media_url?: string, numbers?: string[], seat_id?: string): { account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: object; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }`\n\n**post** `/api/send-group-message`\n\nSend a message to a group of recipients (beta feature)\n\n### Parameters\n\n- `content: string`\n  Message text content\n\n- `from_number: string`\n  **REQUIRED** - The phone number to send from. Must be one of your registered Sendblue phone numbers in E.164 format.\nWithout this parameter, the message will fail to send.\n\n\n- `group_id?: string`\n  Unique identifier for an existing group\n\n- `media_url?: string`\n  URL of media file to send\n\n- `numbers?: string[]`\n  Array of recipient phone numbers in E.164 format\n\n- `seat_id?: string`\n  Optional. Identifies the seat (user) sending the group message so it\nis attributed to a specific rep. Accepts either the seat UUID or the\nFirebase Auth subject. When provided, `sender_email` is auto-populated\non the message record and webhook payloads. Returns 400 if the seat is\nnot found.\n\n\n### Returns\n\n- `{ account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; }`\n\n  - `account_email?: string`\n  - `content?: string`\n  - `date_created?: string`\n  - `date_updated?: string`\n  - `error_code?: number`\n  - `error_message?: string`\n  - `from_number?: string`\n  - `is_outbound?: boolean`\n  - `location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }`\n  - `media_url?: string`\n  - `message_handle?: string`\n  - `message_type?: 'message' | 'group' | 'location'`\n  - `number?: string`\n  - `seat_id?: string`\n  - `send_style?: string`\n  - `sender_email?: string`\n  - `status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'`\n\n### Example\n\n```typescript\nimport SendblueAPI from 'sendblue';\n\nconst client = new SendblueAPI();\n\nconst messageResponse = await client.groups.sendMessage({ content: 'Hello, everyone!', from_number: '+19998887777' });\n\nconsole.log(messageResponse);\n```",
    perLanguage: {
      typescript: {
