...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    markdown:
      "## list\n\n`client.webhooks.list(): { status?: string; webhooks?: object; }`\n\n**get** `/api/account/webhooks`\n\nGet all webhooks configured for the authenticated account\n\n### Returns\n\n- `{ status?: string; webhooks?: { call_log?: string | object[]; contact_created?: string | object[]; globalSecret?: string; line_assigned?: string | object[]; line_blocked?: string | object[]; outbound?: string | object[]; receive?: string | object[]; typing_indicator?: string | object[]; }; }`\n\n  - `status?: string`\n  - `webhooks?: { call_log?: string | { url: string; secret?: string; }[]; contact_created?: string | { url: string; secret?: string; }[]; globalSecret?: string; line_assigned?: string | { url: string; secret?: string; }[]; line_blocked?: string | { url: string; secret?: string; }[]; outbound?: string | { url: string; secret?: string; }[]; receive?: string | { url: string; secret?: string; }[]; typing_indicator?: string | { url: string; secret?: string; }[]; }`\n\n### Example\n\n```typescript\nimport SendblueAPI from 'sendblue';\n\nconst client = new SendblueAPI();\n\nconst webhooks = await client.webhooks.list();\n\nconsole.log(webhooks);\n```",
    perLanguage: {
      typescript: {
