...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; reply_to?: { message_handle: string; part_index?: number; }; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; thread_originator?: { message_handle: string; part?: string; }; }",
    markdown:
      "## get_status\n\n`client.messages.getStatus(handle: string): { account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: object; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; reply_to?: object; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; thread_originator?: object; }`\n\n**get** `/api/status`\n\nRetrieve the current status of a message using its message handle. Useful for resolving pending message statuses and avoiding duplicate messages.\n\n\n### Parameters\n\n- `handle: string`\n  The message handle of the message you want to check status for\n\n### Returns\n\n- `{ account_email?: string; content?: string; date_created?: string; date_updated?: string; error_code?: number; error_message?: string; from_number?: string; is_outbound?: boolean; location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }; media_url?: string; message_handle?: string; message_type?: 'message' | 'group' | 'location'; number?: string; reply_to?: { message_handle: string; part_index?: number; }; seat_id?: string; send_style?: string; sender_email?: string; status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'; thread_originator?: { message_handle: string; part?: string; }; }`\n\n  - `account_email?: string`\n  - `content?: string`\n  - `date_created?: string`\n  - `date_updated?: string`\n  - `error_code?: number`\n  - `error_message?: string`\n  - `from_number?: string`\n  - `is_outbound?: boolean`\n  - `location?: { latitude: number; longitude: number; accuracy?: number; altitude?: number; duration?: string; timestamp?: string; }`\n  - `media_url?: string`\n  - `message_handle?: string`\n  - `message_type?: 'message' | 'group' | 'location'`\n  - `number?: string`\n  - `reply_to?: { message_handle: string; part_index?: number; }`\n  - `seat_id?: string`\n  - `send_style?: string`\n  - `sender_email?: string`\n  - `status?: 'QUEUED' | 'SENT' | 'DELIVERED' | 'ERROR'`\n  - `thread_originator?: { message_handle: string; part?: string; }`\n\n### Example\n\n```typescript\nimport SendblueAPI from 'sendblue';\n\nconst client = new SendblueAPI();\n\nconst messageResponse = await client.messages.getStatus({ handle: 'msg_abc123def456' });\n\nconsole.log(messageResponse);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'retrieve_group_membership',
    ...
    stainlessPath: '(resource) v2 > (method) retrieve_group_membership',
    qualified: 'client.v2.retrieveGroupMembership',
