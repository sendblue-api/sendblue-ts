...
import { SendblueAPI, ClientOptions } from 'sendblue';
...
const fuse = new Fuse(
  [
    ...
    'client.messages.v2.verify.services.verifications.create',
    'client.messages.v2.verify.services.verifications.retrieve',
    ...
    'client.verify.verifications.create',
    'client.verify.verifications.list',
    'client.verify.verifications.retrieve',
  ],
